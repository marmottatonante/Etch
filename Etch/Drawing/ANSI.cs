...
public static class ANSI
{
    ...
    public static void Plot(ArrayBufferWriter<byte> buffer, byte glyph)
    {
        buffer.GetSpan(1)[0] = glyph;
        buffer.Advance(1);
    }

    public static void Blit(ArrayBufferWriter<byte> buffer, ReadOnlySpan<byte> text)
    {
    ...
    public static void Blank(ArrayBufferWriter<byte> buffer, int count)
    {
